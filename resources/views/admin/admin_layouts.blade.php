    ...
    <div class="sl-sideleft">
      ...
      <a href="{{route('admin.brand')}}" class="sl-menu-link @yield('brand')"  >
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.product')}}" class="nav-link @yield('add-products')">Add Product</a></li>
          <li class="nav-item"><a href="{{route('manage.product')}}" class="nav-link @yield('manage-products')">Manage Product</a></li>
        ...
        <a href="{{route('add.coupon')}}" class="sl-menu-link @yield('coupon')"  >
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
        ...
        <a href="{{route('add.orders')}}" class="sl-menu-link @yield('orders')"  >
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
